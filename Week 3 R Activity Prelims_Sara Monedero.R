...
#NO: Height <- Height[65,66,67,68,69,70,71,72]
#NO: filter(Height >= 65)
...
ggplot(womend, aes(x=Height, y=Weight)) + geom_point(shape = 21, colour = "black", fill = "white", size = 5, stroke = 5)
